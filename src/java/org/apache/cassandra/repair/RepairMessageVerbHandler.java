...
public class RepairMessageVerbHandler implements IVerbHandler<RepairMessage>
{
    ...
    {
        logger.info("FL62: RepairMessageVerbHandler.doVerb: message = {}", message);
        if(message.header.isDryRun()){
            logger.info("FL62: RepairMessageVerbHandler.doVerb: message.header.isDryRun is true, return");
            doVerb$instrumentation(message);
            return;
        }
    ...
    public void doVerb$instrumentation(final Message<RepairMessage> message)
    {
        // TODO add cancel/interrupt message
        RepairJobDesc desc = message.payload.desc;
        try
